...
// The option to use `pub` or not for different parts of code enables encapsulation

// of implementation details.

// Remember that by default, everything is private.

// If we want to access methods or functions in public API, we need to specify the `pub` keyword before our data type.
